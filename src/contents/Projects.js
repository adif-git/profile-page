import * as image from '../resources/projects/index'
...
let projectsList = [
    {
        ...
        image: image.IT,
        tags:['Web Development', 'React.js', 'Node.js', 'Docker', 'MongoDB', 'Bootstrap'],
        description: 'Project I build about IT Ticket system. Ticket system is system that are used by IT support to track any hardware/software problems that submitted by user as ticket. This project build using MERN Stack (MongoDB Atlas, Express, Node.js, React.js) with Docker container. Login using passport-local authentication to generate cookies as JWT token. After login, all routes will be using JWT authentication.',
    ...
    },
    {
        ...
        link: '',
        video: 'https://drive.google.com/file/d/1J-nxprEs1lAsyPAfUe4oy9mDJ-SHl0qu/view?usp=sharing',
        github: '',
      },
    {
      id: '3',
      ...
      link: '',
      video: 'https://drive.google.com/file/d/1m7gDiac_ph88rR9GnaivVQUR7A81-cin/view?usp=sharing',
      github: '',
    },
    {
      id: '4',
      ...
      link: '',
      video: 'https://drive.google.com/file/d/1XmU0Hye5k8mDxEsuXnGH0R1XJnGS0aVL/view?usp=sharing',
      github: '',
    },
    {
      id: '5',
      ...
      description: 'This is my water tandon project using AT89S51 Microcontroller in Assembly Language. Sensors are used to indicate water level in the container and water level will be showed using 2 red LEDs. White LED shows on water pump behaviour.',
      link: '',
      video: 'https://drive.google.com/file/d/1-6Y2x8fUxX5pQXpT8p4y0iOeyCPnkuoK/view?usp=sharing',
